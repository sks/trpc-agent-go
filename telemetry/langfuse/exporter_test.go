...
func TestTransformCallLLM_UsageDetails(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			outputTokens:  50,
			cachedTokens:  30,
			expectedUsage: map[string]int64{"input": 100, "output": 50, "total": 150, "input_cached": 30, "cached_tokens": 30},
		},
		{
		...
		},
		{
			...
			expectedUsage:       map[string]int64{"input": 300, "output": 100, "total": 400, "input_cached": 50, "cached_tokens": 50, "input_cache_read": 70, "input_cache_creation": 20},
		},
		{
